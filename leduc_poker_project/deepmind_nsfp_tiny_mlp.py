...
def train(args):
    ...
    print(f"Inizio run \033[92m{run_name}\033[0m con architettura TINY: {hidden_layers}")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--hidden_list", type=str, default="16,16", help="Strati separati da virgola")
